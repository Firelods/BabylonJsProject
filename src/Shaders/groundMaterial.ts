...
(function () {
    WORLDMONGER.GroundMaterial = function (name, scene, light) {
        ...
        this.grassTexture = new BABYLON.Texture("src/Shaders/Ground/grass.jpg", scene);
        this.grassTexture.uScale = 2.0;
        this.grassTexture.vScale = 2.0;

        this.snowTexture = new BABYLON.Texture("src/Shaders/Ground/snow.jpg", scene);
        this.snowTexture.uScale = 20.0;
        this.snowTexture.vScale = 20.0;

        this.sandTexture = new BABYLON.Texture("src/Shaders/Ground/lowpoly.jpg", scene);
        this.sandTexture.uScale = 2.0;
        this.sandTexture.vScale = 2.0;

        this.rockTexture = new BABYLON.Texture("src/Shaders/Ground/rock.jpg", scene);
        this.rockTexture.uScale = 15.0;
        this.rockTexture.vScale = 15.0;

        this.blendTexture = new BABYLON.Texture("src/Shaders/Ground/blend.png", scene);
    ...
    WORLDMONGER.GroundMaterial.prototype.isReady = function (mesh) {
        ...
        if (this._cachedDefines != join) {
            ...
            this._effect = engine.createEffect("./src/Shaders/Ground/ground",
                ["position", "normal", "uv"],
